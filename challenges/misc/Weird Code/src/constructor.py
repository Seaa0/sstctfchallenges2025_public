#slightly modified from https://github.com/wanqizhu/pyfuck
#/usr/bin/python3
import re
...
def encode(s, with_eval=False):
    ...
    for c in s:
        ...
        if not c.isdigit()  and c not in DICT:
...
# test("print('sstctf{pl3as3_don+_wr1te_c0de_lik3_th15...}')",1)

with open('code.py','r') as f:
    code = f.read()
with open('weird code.txt','w') as f:
    f.write('exec('+test(code)+')')